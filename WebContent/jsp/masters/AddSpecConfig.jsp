...
<div id="page-inner">
            <div class="row">
                <div class="col-md-11 col-sm-8 col-xs-8">
                    <h3 class="add-page-header">Specification Configuration</h3>
                </div>
<!--                 <div class="col-md-1 col-sm-4 col-xs-4 pull-right">
		...
		<div class='row'>
            <div class='col-sm-3'>    
                <div class='form-group'>
                    <label for="customer">Group Type</label>
		...
		<div class='col-sm-3'>    
                <div class='form-group'>
                    <label for="customer">Heading</label>
                    </div>
                    </div>
		<div class='col-sm-3'>    
                <div class='form-group'>
                    <label for="customer">Length of Code</label>
                    </div>
                    </div>                    
		</div>
		...
		<div class='col-sm-1'>    
                <div class='form-group'>
                    <label for="customer">Spec1</label>
                    </div>
                    </div>
		<div class='col-sm-3'>    
                <div class='form-group'>
		...
		<div class='col-sm-1'>    
                <div class='form-group'>
                    <label for="customer">Spec2</label>
                    </div>
                    </div>
		<div class='col-sm-3'>    
                <div class='form-group'>
		...
		<div class='col-sm-1'>    
                <div class='form-group'>
                    <label for="customer">Spec3</label>
                    </div>
                    </div>
		<div class='col-sm-3'>    
                <div class='form-group'>
		...
		<div class='col-sm-1'>    
                <div class='form-group'>
                    <label for="customer">Spec4</label>
                    </div>
                    </div>
		<div class='col-sm-3'>    
                <div class='form-group'>
		...
		<div class='col-sm-1'>    
                <div class='form-group'>
                    <label for="customer">Spec5</label>
                    </div>
                    </div>
		<div class='col-sm-3'>    
                <div class='form-group'>
		...
		<div class='col-sm-1'>    
                <div class='form-group'>
                    <label for="customer">Spec6</label>
                    </div>
                    </div>
		<div class='col-sm-3'>    
                <div class='form-group'>
		...
		<div class='col-sm-1'>    
                <div class='form-group'>
                    <label for="customer">Spec7</label>
                    </div>
                    </div>
		<div class='col-sm-3'>    
                <div class='form-group'>
...
<div class='row pull-left'>        	         	 
            ...
            <li><a href="#" >Save & New</a></li>
                  ...
                  <li><a href="#">Save & Close</a></li>
                   ...
                   <button type="button" class="btn btn-danger" onclick="showSpecConfig()">Cancel</button>						             
            </div>            
    </div>  
   </div>
  </div> 

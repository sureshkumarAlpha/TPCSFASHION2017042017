...
<div class="col-sm-3">
		 <div class="form-group">
		    ...
		    <div class="required-field-block">
                    <input class="form-control" id="bom_no"  name="bom_no" size="30" <c:if test="${bom.headerMode eq 'n'}">autofocus</c:if> type="text" value="${header_info.bomNo}" onblur="chkBomNoExist();"  placeholder="Enter BOM No">
...
<!--  --------------------------------------------------Header Part End-------------------------------------------------------------------------------------------- -->
    ...
    <!--  --------------------------------------------------Detail Part Starts with Dynamic Fields-------------------------------------------------------------------------------------------- -->   
         <div class="row table-responsive">
           <div class="col-sm-12">
         <table class="table table-bordered table-condensed table-hover" id="grid_table" style="min-width:${header_info.detTableWidth}px;"  >
<thead>
<tr class="header-det">
	...
	<c:forEach items="${dynamicFieldsListBOMDetails}" var="dynamicDetailfield" >
						...
						<c:set var="ControlName" value="${dynamicDetailfield.pageFieldName}" />
							<c:choose>
									<c:when test="${ControlName eq 'component_id'}">
											<th width="${dynamicDetailfield.columnWidth}px">${dynamicDetailfield.displayName}</th>
									</c:when>
									<c:otherwise>
								<c:choose>
									<c:when test="${ControlName eq 'material_id'}">
										<%-- <th class="col-width-10">${dynamicDetailfield.displayName}</th> --%>
											<th width="${dynamicDetailfield.columnWidth}px">${dynamicDetailfield.displayName}</th>
									</c:when>
									<c:otherwise>
										<c:choose>
											<c:when test="${ControlName=='variant_id'}">
												<%-- <th class="col-width-8">${dynamicDetailfield.displayName}</th> --%>
													<th width="${dynamicDetailfield.columnWidth}px">${dynamicDetailfield.displayName}</th>
											</c:when>
											...
											<c:otherwise>
												<c:choose>
													...
													<%-- 	<th class="col-width-4">${dynamicDetailfield.displayName}</th> --%>
														<th width="${dynamicDetailfield.columnWidth}px">${dynamicDetailfield.displayName}</th>
													</c:when>
																	...
																	<c:otherwise>
																		<c:choose>
																			<c:when test="${ControlName=='wastage_per'}">
																				<%-- <th class="col-width-5" >${dynamicDetailfield.displayName}</th> --%>
																				<th width="${dynamicDetailfield.columnWidth}px">${dynamicDetailfield.displayName}</th>
																			</c:when>
              ...
              <c:set var="k" value="${1}"/>
					...
					<td ><div class='form-group grid-slno'>${k}</div></td>
				...
				<%-- 				--%>
										...
										<c:set var="ControlName"
											...
											<c:choose>
															...
															<input class="form-control "
																		...
																		value="${det.component}" type="text"  maxlength="${dynamicDetailfield.length}" 
														 ...
														 <script>
				                                               	setFocusWidth('component_S_${det.bomDetailId}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
				                                    	</script>
												...
												<c:choose>
													...
													<script>
				                                               	setFocusWidth('material_S_${det.bomDetailId}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
				                                    	</script>
												...
												<div class='form-group'>
												                 <input class="form-control "
																		...
																		value="${det.variant}" type="text"  maxlength="${dynamicDetailfield.length}" 
																		placeholder="${dynamicDetailfield.displayName}" />
																		<input type="hidden" name="variant_id_S_${det.bomDetailId}" id="variant_id_S_${det.bomDetailId}" value="${det.variantId}" />
																    </div>
																    
														<script>
				                                               	setFocusWidth('variant_S_${det.bomDetailId}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
				                                    	</script>
															...
															<c:otherwise>
																<c:choose>
																	...
																	<div class="text">*</div>
																     ...
																     <script>
				                                               	setFocusWidth('uom_S_${det.bomDetailId}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
				                                    				</script>
																	 ...
																	 <script>
				                                               				setFocusWidth('operation_S_${det.bomDetailId}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
				                                    				</script>
																					...
																					<td>
																					  <div class="form-group required-field-block">
																	                    <input type="text" class="form-control text-right"
																									...
																									id="required_qty_S_${det.bomDetailId}"  maxlength="${dynamicDetailfield.length}" 
																						...
																						<c:otherwise>
																							...
																							<div class='form-group'>
																											<input class="form-control text-right"
																												name="wastage_per_S_${det.bomDetailId}"  maxlength="${dynamicDetailfield.length}" 
																																...
																																<c:when
																																	...
																																	<div class='form-group'>
																																		<input type="text" 
																																			...
																																			value="${det.issuePer}"
																																			name="issue_per_S_${det.bomDetailId}"  maxlength="${dynamicDetailfield.length}" 
																													...
																													<!-- 		<script>
																															...
																															<c:choose>
																																...
																																<div class='form-group'>
																																		<input type="text" 
																																			class="form-control "
																																			value="${det.supplier}"
																																			name="supplier_S_${det.bomDetailId}"  maxlength="${dynamicDetailfield.length}" 
																																...
																																<script>
											                                               			                 	setFocusWidth('supplier_S_${det.bomDetailId}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
											                                    				                      </script>
																															...
																															<c:choose>
																																<c:when
																																	...
																																	<div class='form-group'>
																																		<input type="text" 
																																			class="form-control text-right"
																																			value="${det.usageArea}"  maxlength="${dynamicDetailfield.length}" 
																															...
																															<div class='form-group'>
																																		<input type="text" 
																																			...
																																			placeholder="${dynamicDetailfield.displayName}" 
																																			id="size_schedule_S_${det.bomDetailId}"  maxlength="${dynamicDetailfield.length}"  />
																															...
																															<script>
															                                               			                 	setFocusWidth('size_schedule_S_${det.bomDetailId}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
															                                    				                      </script>	
																															...
																															<div class='form-group'>
																																		<input type="text" 
																																			...
																																			placeholder="${dynamicDetailfield.displayName}" 
																																			id="group_name_S_${det.bomDetailId}"  maxlength="${dynamicDetailfield.length}"  />
																														<input type="hidden" value="${det.groupId}" name="group_id_S_${det.bomDetailId}" id="group_id_S_${det.bomDetailId}" />
																																			
																															</div>
																															
																															<script>
															                                               			                 	setFocusWidth('group_name_S_${det.bomDetailId}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
															                                    				                      </script>	
									...
									<c:set var="f_name" value="${dynamicDetailfield.dbFieldName}${det.bomDetailId}" />
													...
													<c:when test="${dynamicDetailfield.dataTypeName == 'Date'}">
														...
														<script type="text/javascript">
													      ...
													      jQuery('#${dynamicDetailfield.pageFieldName}_S_${det.bomDetailId}').datepicker({
									        					...
									        					<script>
															 setFocusWidth('${dynamicDetailfield.pageFieldName}_S_${det.bomDetailId}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
															</script>	
										...
										<div class='form-group'>
											 <c:choose>
														...
														class="form-control" rows="1" onfocus="this.rows=5;"  onblur="this.rows=1;"  ${strEvent} placeholder="Enter ${dynamicDetailfield.displayName}" 
														value="<%=value %>" 
					...
					<td>	
						...
						<div class="box-group ">
		<div class="form-group">
		<button type="button" class="btn btn-primary" data-toggle="tooltip" data-original-title="BOM Components" onclick="validateBOM('${bom.headerMode}','bomComp','${det.bomDetailId}');">&nbsp;<i class="glyphicon glyphicon-th-list"></i><span>&nbsp;Components</span></button>
		</div>
		</div>
		</td>
		...
		<div class="box-group ">
		<div class="form-group">
		<button type="button" class="btn btn-primary" data-toggle="tooltip" data-original-title="Alternate Material" id="alt_mat_${det.bomDetailId}"  onclick="validateBOM('${bom.headerMode}','altMat','${det.bomDetailId}');"><i class="glyphicon glyphicon-list-alt"></i><span>&nbsp;Alt Mat</span></button>
		</div>
		</div>
...
<div class='form-group grid-slno'>${k}</div>
										...
										value="${dynamicDetailfield.pageFieldName}" />
											<c:choose>
													...
													<div class='form-group'>
																	...
																	name="component_${t_det_id}" id="component_${t_det_id}" maxlength="${dynamicDetailfield.length}"/>
																     	<input type="hidden" name="component_id_${t_det_id}" id="component_id_${t_det_id}" />
													</div>
													
													
																<script>
																	setFocusWidth('component_${t_det_id}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
															</script>
														</td>
														</c:when>
														...
														<input type="hidden" name="material_id_${t_det_id}"
															id="material_id_${t_det_id}" />
																	...
																	<div class="text">*</div>
																     ...
																     <script>
																	setFocusWidth('material_${t_det_id}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
																	</script>
												</td>
												</c:when>
												<c:otherwise>
													<c:choose>
														...
														<td>
															  <div class='form-group'>
												                  	<input type="text" class="form-control"  maxlength="${dynamicDetailfield.length}"  placeholder="${dynamicDetailfield.displayName}" 
																	name="variant_${t_det_id}" id="variant_${t_det_id}"
																	 />
														              ...
														              <script>
																	setFocusWidth('variant_${t_det_id}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
																	</script>
														</td>
														</c:when>
														...
														<c:otherwise>
															...
															<td>
																	...
																	<div class="text">*</div>
																      ...
																      <script>
																		setFocusWidth('uom_${t_det_id}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
																	</script>
																</td>
																</c:when>
																...
																<c:otherwise>
																 ...
																 <!--     <div class="required-icon">
																	<div class="text">*</div>
																     	      ...
																     	      <script>
																		setFocusWidth('operation_${t_det_id}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
																	</script>
																		</td>
																		</c:when>
																	  ...
																	  <div class="form-group required-field-block">
																		...
																		setFocusWidth('required_qty_${t_det_id}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
																				...
																				<td>
																								<div class='form-group'>
																										<input type="text" class="form-control text-right" maxlength="${dynamicDetailfield.length}" 
																											name="wastage_per_${t_det_id}" placeholder="Enter ${dynamicDetailfield.displayName}"
																						...
																						<c:otherwise>
																							<c:choose>
																							 ...
																							 <!--    <script>
																								...
																								<div class='form-group'>
																										<input type="text" class="form-control text-right" maxlength="${dynamicDetailfield.length}" 
																											name="issue_per_${t_det_id}" placeholder="Enter ${dynamicDetailfield.displayName}"
																			 ...
																			 <input type="hidden" name="supplier_id_${t_det_id}" id="supplier_id_${t_det_id}" />
																								...
																								<script>
																									setFocusWidth('supplier_${t_det_id}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
																								</script>
																									</td>
																									</c:when>
																									<c:otherwise>
																						...
																						<td>
																						<div class='form-group'>
																												<input type="text" class="form-control "   maxlength="${dynamicDetailfield.length}"  placeholder="${dynamicDetailfield.displayName}" name="size_schedule_${t_det_id}"   id="size_schedule_${t_det_id}"  >
																													<input type="hidden" name="size_schedule_id_${t_det_id}"   id="size_schedule_id_${t_det_id}"  >
																										</div>
																										
																										
																										<script>
																									setFocusWidth('size_schedule_${t_det_id}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
																								</script>
																														...
																														<c:otherwise>
																															...
																															<div class='form-group'>
																																		<input type="text" 
																																			class="form-control "  name="group_name_${t_det_id}"
																																			placeholder="${dynamicDetailfield.displayName}" 
																																			id="group_name_${t_det_id}"  maxlength="${dynamicDetailfield.length}"  />
																														<input type="hidden" name="group_id_${t_det_id}" id="group_id_${t_det_id}" />
																																			
																															</div>
																															
																															<script>
																								                     	setFocusWidth('group_name_${t_det_id}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
																								                   </script>
																																</td>
																																</c:when>
																															</c:choose> 
									...
									<c:choose>
										<c:when
											...
											<div class='form-group'>
													<div class="input-daterange has-feedback"
									        			...
									        			<script>
				                                               	setFocusWidth('${dynamicDetailfield.pageFieldName}_${t_det_id}','${dynamicDetailfield.length}','${dynamicDetailfield.columnWidth}');
				                                    	</script>
										...
										<div class='form-group'>
											<c:choose>
														...
														name="${dynamicDetailfield.pageFieldName}_${t_det_id}" onfocus="this.rows=5;"  onblur="this.rows=1;" type="text" placeholder="Enter ${dynamicDetailfield.displayName}"
                    ...
                    <td>
                    		<div class="box-group ">
		<div class="form-group">
		<button type="button" class="btn btn-primary" data-toggle="tooltip" data-original-title="BOM Components" onclick="validateBOM('${bom.headerMode}','bomComp',0);">&nbsp;<i class="glyphicon glyphicon-th-list"></i><span>&nbsp;Components</span></button>
		</div>
		</div>
		</td>
		...
		<td>
                    		<div class="box-group ">
		<div class="form-group">
		<button type="button" class="btn btn-primary" data-toggle="tooltip" data-original-title="Alternate Material" id="alt_mat_0"  onclick="validateBOM('${bom.headerMode}','altMat',0);"><i class="glyphicon glyphicon-list-alt"></i><span>&nbsp;Alt Mat</span></button>
		</div>
		</div>
		
		
		<%-- <a href="javascript:addBOMComp(${t_det_id})"   data-toggle="tooltip" title="" data-original-title="Add BOM Components"><span class="glyphicon glyphicon-plus text-primary"></span></a>&nbsp; --%>
...
<img id="ajax-loader" src="images/ajax-loader.gif" class="ajax-loader">
    ...
    <div class='pull-right centered text-save-view'>   
                ...
                <button    class="btn btn-success dropdown-toggle" data-toggle="dropdown" style="height:24px;"><span class="caret"></span></button>

...
var uomlocalizedStrings = {
		...
		UOM_SAVED_FAILED: "<fmt:message  bundle="${bundle}" key="UOM.CreateGroupFailed"/>"
}
</script>
<style>
@media screen and (min-width: 992px) {
#validate-form-sales_acc .modal-lg {
    width: 1200px;
}
}
</style>
<form id="validate-form-sales_acc">
	<div class="form-horizontal trans-form">
		<div class="modal fade" id="salesAccountModal" role="dialog" >
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Sales Account Configuration</h4>
					</div>
					<div class="modal-body" style="max-height:450px;    overflow: auto;">
					
					<div id="sales_account_1_0_content">
					<label> I will select sales account in every Transaction manually</label>
					</div>
					
					<div id="sales_account_2_1_content">
					
						<!--   <div class='row'>
							<div class="form-group">
								<label class="col-sm-4 control-label" for="sales_account">Sales account head</label>
								<div class="col-sm-8">
									<div class="required-field-block">
										<input class="form-control" id="sales_account" name="sales_account"
						...
						<div id="sales_account_3_1_content">
										...
										<table class="table table-bordered table-condensed" id="addrow_table">
											...
											<tbody>
												<tr class="datarow">
													...
													<td><input class="form-control" id="3_1_sales_account" name="3_1_sales_account" type="text"></td>
						...
						<div id="sales_account_3_2_content">
					 <!-- <div class="table-responsive">
										...
										<table class="table table-bordered table-condensed" id="addrow_table">
											...
											<tbody>
												<tr class="datarow">
													...
													<td><input class="form-control" id="3_2_sales_account" name="3_2_sales_account" type="text"></td>
						...
						<div id="sales_account_4_1_content">
					  <!-- <div class="table-responsive">
										...
										<table class="table table-bordered table-condensed" id="addrow_table">
											...
											<tbody>
												<tr class="datarow">
													...
													<td><input class="form-control" id="4_1_sales_account" name="4_1_sales_account" type="text"></td>
						...
						<div id="sales_account_4_2_content">
					  <!-- <div class="table-responsive">
										...
										<table class="table table-bordered table-condensed" id="addrow_table">
											...
											<tbody>
												<tr class="datarow">
													...
													<td><input class="form-control" id="4_2_sales_account" name="4_2_sales_account" type="text"></td>
						...
						<div id="sales_account_5_1_content">
						<!-- <div class="table-responsive">
										...
										<table class="table table-bordered table-condensed" id="addrow_table">
											...
											<tbody>
												<tr class="datarow">
													...
													<td><input class="form-control" id="5_1_sales_account" name="5_1_sales_account" type="text"></td>
						...
						<div id="sales_account_5_2_content">
						<!-- <div class="table-responsive">
										...
										<table class="table table-bordered table-condensed" id="addrow_table">
											...
											<tbody>
												<tr class="datarow">
													...
													<td><input class="form-control" id="5_2_sales_account" name="5_2_sales_account" type="text"></td>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-success" onclick="saveSalesAccount()">Save Configuration</button>
						...
						<input type="hidden" name="from_so_manual_acc" id="from_so_manual_acc" />
						...
						<input type="hidden" name="manual_sales_acc_input" id="manual_sales_acc_input" />
						<input type="hidden" name="manual_sales_acc_input_name" id="manual_sales_acc_input_name" />
						...
						<input type="hidden" name="sales_type_id_5_1" id="sales_type_id_5_1" />
...
/* 	modal.$el.on('shown', function () {
		...
		$('#validate-form-sales_acc .modal').on('shown.bs.modal', function () {
		   $('#validate-form-sales_acc input:text:visible:first', this).focus();
			$('#validate-form-sales_acc select:visible:first', this).focus();
		   $('#validate-form-sales_acc textarea:visible:first', this).focus();
		});
		$('#validate-form-sales_acc').bootstrapValidator({
			//  live: 'disabled',
...
function formSalesAccountWithAjax(inputIds){
...
var parentId=jQuery("#validate-form-sales_acc #parent_id").val();
var childId=jQuery("#validate-form-sales_acc #child_id").val();
var groupId='';
if(parentId=='3' && childId=='1'){
	groupId=jQuery('#validate-form-sales_acc #group_id_3_1').val();
}
else if(parentId=='3' && childId=='2'){
	groupId=jQuery('#validate-form-sales_acc #product_id_3_2').val();
}
else if(parentId=='4' && childId=='1'){
	groupId=jQuery('#validate-form-sales_acc #tax_group_id_4_1').val();
}
else if(parentId=='4' && childId=='2'){
	groupId=jQuery('#validate-form-sales_acc #group_id_4_2').val();
}
else if(parentId=='5' && childId=='1'){
	groupId=jQuery('#validate-form-sales_acc #sales_type_id_5_1').val();
}
else if(parentId=='5' && childId=='2'){
	groupId=jQuery('#validate-form-sales_acc #group_id_5_2').val();
}
	...
	if(parentId=='2' && childId=='1'){
		for(var j=0;j<arInputIds.length;j++){
			inputData=inputData+arInputIds[j]+":jQuery(\"#validate-form-sales_acc #"+arInputIds[j]+"\").val(),";			
		}
	}
	else{
		...
		for(var i=0;i<arGroupId.length;i++){
			for(var j=0;j<arInputIds.length;j++){
				inputData=inputData+arInputIds[j]+"_"+parentId+"_"+childId+"_"+arGroupId[i]+":jQuery(\"#validate-form-sales_acc #"+arInputIds[j]+"_"+parentId+"_"+childId+"_"+arGroupId[i]+"\").val(),";
			}
		}
	}
	
	var data=" servlet_name : 'SalesAccountConfigurationServlet' , callbackmethod_name : 'doSaveSalesAccountConfigModalData',si_ajax_save:'1',"+inputData+"parent_id:jQuery('#validate-form-sales_acc #parent_id').val(),child_id:jQuery('#validate-form-sales_acc #child_id').val(),tax_group_id:jQuery('#validate-form-sales_acc #tax_group_id').val(),input_id:jQuery('#validate-form-sales_acc #input_id').val(),group_id_3_1:jQuery('#validate-form-sales_acc #group_id_3_1').val(),product_id_3_2:jQuery('#validate-form-sales_acc #product_id_3_2').val(),tax_group_id_4_1:jQuery('#validate-form-sales_acc #tax_group_id_4_1').val(),group_id_4_2:jQuery('#validate-form-sales_acc #group_id_4_2').val(),sales_type_id_5_1:jQuery('#validate-form-sales_acc #sales_type_id_5_1').val(),group_id_5_2:jQuery('#validate-form-sales_acc #group_id_5_2').val()";
	
	var script="<script language='javascript'> function configureSalesAccountWithAjax(){";
	...
	script=script+" jQuery('#salesAccountModal').modal('hide')";
	script=script+" });";

...
<script language="javascript">
	...
	function getMaterialData(selectedFields,totalColumns){
		...
		setVal('servlet_name','ColorServlet');
		setVal('callbackmethod_name','doDisplayColorAfterColumnOrganized');
	...
	<form action="" id="tpcslogin" method="post" role="form"
		...
		<div id="wrapper">
			...
			<jsp:include page="../common/MainMenu.jsp">
				...
				<jsp:param value="Admin.Products.Color" name="screen_name" />
					...
					<div class="row row-no-margin">
						...
						<div class='col-sm-3'>
							<div class='form-group'>
								<label for="so_customer">Color Code</label> <input type="text"
									class="form-control" name="color_code" id="color_code"
									placeholder="Color Code Search..." value="${color_code}"
									onblur="" onkeyup=""
									onkeypress="enterKeyPress(event,'search');" /> <input
									id="color_id" name="color_id" size="30" type="hidden"
									value="${color_id}" />
							</div>
						</div>
...
<c:if test="${color_rights.addPermission==1 }">	
						<div class='col-sm-2 pull-right new_tran_btn'>
							<div class='form-group pull-right'>
								<a onclick="addColor('n')" class="btn btn-success"><i
									class="glyphicon glyphicon-plus-sign"></i>&nbsp;New Color</a>
							</div>
						</div>
					...
					<div class="row row-no-margin paginationstyle">
						<div class='col-sm-12'>
							...
							<ul class="pagination pull-left">
								<li><a href='javascript:showColor();' data-toggle="tooltip"
					...
					<li >
						<a  href="#"  onclick="showColorConfigScreensForId('4')" data-toggle="tooltip" title="Customization">
						<i class="glyphicon glyphicon-cog"></i>
									...
									<div class="dropdown dropdown-lg">
										...
										<div id="filter-dropdown"
											...
											<div class="row">
												<div class='col-sm-6'>
													<div class='form-group'>
														<label for="group">Description</label> <input type="text"
															class="form-control" name="color_desc" id="color_desc"
															value="${color_desc}" placeholder="Type Description..." />
													</div>
												</div>
							...
							<div class="btn-group pull-right">
								...
								<ul class="dropdown-menu">
									<li><a href='javascript:activeBulkColor(${pc.pageNo},1)'>Active</a></li>
									<li><a href='javascript:activeBulkColor(${pc.pageNo},2)'>Inactive</a></li>

	...
	<form action="" method="post" role="form" id="validate-form"
		...
		<div class="wrapper">
					...
					<div class="row">
						<div class="col-sm-3">
							<div class='form-group'>
								<label for="customer">Variant Code</label>
								<div class="required-field-block">
									<input class="form-control" id="variant_code" name="variant_code"
										size="30" type="text" placeholder="Enter variant Code"
										value="${variant_info.variantCode}" /> <input id="variant_id"
										name="variant_id" size="30" type="hidden"
										value="${variant_info.variantId}" autofocus />
				...
				<div class='col-sm-3'>
							<div class='form-group'>
								<label>Status</label> <select class="form-control"
									...
									<option value="1"
										<c:if test="${variant_info.status eq 1 }">selected="selected"</c:if>>Active</option>
									<option value="0"
										<c:if test="${variant_info.status eq 0 }">selected="selected"</c:if>>Inactive</option>
								</select>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<div class='form-group'>
								<label for="customer">Variant Name</label>
								<div class="required-field-block">
									<input class="form-control" id="variant_name" name="variant_name"
										size="250" type="text" placeholder="Enter Variant name"
										value="${variant_info.variantName}" />
									<div class="required-icon">
										<div class="text">*</div>
									</div>
								</div>
						...
						<div class="col-sm-3">
							<div class='form-group'>
								...
								<textarea class="form-control address-text-area" rows="6"
									...
									maxlength="250" data-bv-field="ship_to_address">${variant_info.remarks}</textarea>
			...
			<c:forEach items="${dynamicFieldsListOrderHeader}" var="dynamicHeaderfield" >
				<!-- <div class='col-sm-3'  > -->
					<div class='form-group'>
			         	<%@ include file="../dynamic/VariantControls.jsp" %> 
					</div>
				<!-- </div> -->
				</c:forEach>
			</div>
					...
					<br>
<c:if test="${Variant_rights.addPermission==1 or group_rights.editPermission==1 }">
						...
						<div class="col-sm-12 col-xs-12 centered">
							...
							<div class="btn-group dropdown">
								...
								<button name="save" id="save"
									onclick="saveVariantConfiguration('${mode}','1')"
     ...
     <c:if test="${Variant_rights.addPermission==1 }">	
									...
									<li><a
										href="javascript:saveVariantConfiguration('${mode}','2');">Save
											&amp; New</a></li>
</c:if>
<c:if test="${Variant_rights.viewPermission==1 }">
									<li><a
										href="javascript:saveVariantConfiguration('${mode}','3');">Save
											&amp; Close</a></li>
</c:if>
</c:if>
								</ul>

...
<div id="page-inner">
        <div class="row">
                <div class="col-md-11 col-sm-8 col-xs-8">
                    <h3 class="add-page-header">Edit Report</h3>
                </div>
        ...
        <div class='row'>
            <div class='col-sm-3 col-xs-12'>    
                <div class='form-group'>
                    <label for="BasicUnit">Report Name</label>	
                         <div class="required-field-block">	   
                    <input class="form-control" id="BasicUnit" name="basicUnit" size="30" type="text" placeholder="Enter Report Name"/>	
        ...
        <div class='row'>     
           <div class='col-sm-3 col-xs-12'>           
      <div class='form-group'>
                    <label for="tag">Report Folder</label>

 ...
 <jsp:param value="2" name="screen_type"/>
     ...
     <div class="row-no-margin row">
                <div class="col-md-11 col-sm-8 col-xs-12">
                    <h2 class="add-page-header" style="margin:18px 0 0px 20px;">Stock Adjustment(ADJ)</h2>
                </div>
                  </div>
	...
	<div class="row">
		<div class="col-sm-3">
		 <div class='form-group'>
                    <label for="customer">ADJ No</label>
		    <div class="required-field-block">
                    <input class="form-control" id="ADJ_no" name="ADJ_no" size="30" type="text" placeholder="Type and select ADJ No"/>
		 ...
		 <div class='col-sm-3'>    
			...
			<div class="text">*</div>
             ...
             <div class='col-sm-3'>
                <div class='form-group'>
                    <label for="quotation">Adjustment Type</label>
     ...
     <div class="row" style="margin-top:50px;">
		...
		<div class="col-md-1-5 col-xs-12" >
		<input class="form-control" id="Qty" name="Qty" type="text" placeholder="Requested Qty "/>
		</div>
		<div class="col-md-1-5 col-xs-12" >
		<input class="form-control" id="Qty" name="Qty" type="text" placeholder="Authorized Qty "/>
		</div>
    ...
    <div class='pull-right centered save-view'>            
            ...
            <li><a href="#" >Save & New</a></li>
                  ...
                  <li><a  href="#">Save & Close</a></li>
                   ...
                   <button type="button" class="btn btn-primary"  onclick="showAdjustments()"><i class="glyphicon glyphicon-eye-open"></i><span>&nbsp;View</span></button>	

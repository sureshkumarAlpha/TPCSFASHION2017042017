...
<div id="page-inner">
         <div class="row">
                <div class="col-md-11 col-sm-12 col-xs-8">
                  <h2 class="page-header">Stock Transfers(ST)</h2>
                </div>	
         </div>
         <div class="row row-no-margin" > 
				...
				<label for="so_customer">ST No</label>
				<input type="text" class="form-control"  name="SD_No" id="SD_No" placeholder=" Stock Transfers No Search..." value="" onblur=""  onkeyup="" onkeypress=""/>
				</div>
            </div>
			...
			<a onclick="addTransfers()"  class="btn btn-success"  ><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;New Stock Transfers</a>
			</div>
			</div>	
			...
			<div class='col-sm-12'>    
				...
				<div class="input-group-btn pull-left">
                    <div class="btn-group">
						...
						<div class='col-sm-6 '>
						<label for="material" >Transfer Type</label>
						<div class="box-group ">
...
<div class="btn-group pull-right">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="#"> Accept Receipts</a></li>
    </ul>
</div>
...
<th width="60">ST&nbsp;No</th>
<th width="49">Date</th>
<th width="96">Transfer&nbsp;Type</th>
<td width="88"><strong>Transfer&nbsp;From</strong></td>
<th width="80">Transfer&nbsp;To</th>
<th width="53">Item</th>
<th width="60">Colour</th>
<th width="46">UOM</th>
<th width="76">Issued&nbsp;Qty</th>
<th width="94">Received&nbsp;Qty</th>
<th width="34">Rate/Unit</th>
<th width="56">Amount(INR)</th>
<th width="80">Description</th>
<th width="77">Attachment</th>
<th width="26"><div class="checkbox"><input class="checkbox_1" type="checkbox" id="toggle_check_all" name="toggle_check_all">
...
<select class="form-control" id="unit">
			    ...
			    <option>Accept Receipt</option>  
			  </select></td>
<td height="34" width="64">233.2015</td>
<td width="94" nowrap="nowrap">23-Jan-16</td>
<td width="86">Warehouse</td>
<td width="134">Unit A</td>
<td width="64">Unit B</td>
...
<td width="86">Store</td>
<td width="134">Material</td>

 ...
 <jsp:param value="2" name="screen_type"/>
     ...
     <div class="row-no-margin row">
                <div class="col-md-11 col-sm-8 col-xs-12">
                    <h2 class="add-page-header" style="margin:18px 0 0px 20px;">Sales Return(SR)</h2>
                </div>
                  </div>
	...
	<div class="row">
		<div class="col-sm-3">
		 <div class='form-group'>
                    <label for="customer">SR No</label>
		    <div class="required-field-block">
                    <input class="form-control" id="sr_no" name="sr_no" size="30" type="text" placeholder="Type and select Sales Return No"/>
    ...
    <div class='pull-right centered save-view'>            
            ...
            <li><a href="#" >Save & New</a></li>
                  ...
                  <li><a  href="#">Save & Close</a></li>
                   ...
                   <button type="button" class="btn btn-primary"  onclick="showSalesReturn()"><i class="glyphicon glyphicon-eye-open"></i><span>&nbsp;View</span></button>	

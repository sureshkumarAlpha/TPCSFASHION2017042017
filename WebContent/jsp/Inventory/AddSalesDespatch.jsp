 ...
 <jsp:param value="2" name="screen_type"/>
     ...
     <div class="row-no-margin row">
                <div class="col-md-11 col-sm-8 col-xs-12">
                    <h2 class="add-page-header" style="margin:18px 0 0px 20px;">Sales Despatch(SD)</h2>
                </div>
                  </div>
...
<div class="page-inner"> 
	...
	<div class="row">
		<div class="col-sm-3">
		 <div class='form-group'>
                    <label for="customer">SD No</label>
		    <div class="required-field-block">
                    <input class="form-control" id="sd_no" name="sd_no" size="30" type="text" placeholder="Type and select Sales Despatch No"/>
	...
	<div class="row">
	 ...
	 <div class='col-sm-3'>
                <div class='form-group'>
                    <label for="quotation">Customer</label>
     ...
     <div class="row" style="margin-top:50px;">
        ...
        <input class="form-control" id="Buyer_Order_No" name="Buyer_Order_No" type="text" placeholder="Buyer Order No"/>
        </div>
        <div class="col-md-1-5 col-xs-12">
			<input class="form-control" id="Product" name="Product" type="text" placeholder="Product"/>
		</div>
		<div class="col-md-1-5 col-xs-12" >
    ...
    <div class='pull-right centered save-view'>            
            ...
            <li><a href="#" >Save & New</a></li>
                  ...
                  <li><a  href="#">Save & Close</a></li>
                   ...
                   <button type="button" class="btn btn-primary"  onclick="showSalesDespatch()"><i class="glyphicon glyphicon-eye-open"></i><span>&nbsp;View</span></button>	

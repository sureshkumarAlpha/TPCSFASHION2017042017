 ...
 <jsp:param value="2" name="screen_type"/>
     ...
     <div class="row-no-margin row">
                <div class="col-md-11 col-sm-8 col-xs-12">
                    <h2 class="add-page-header" style="margin:18px 0 0px 20px;">Returns (RET)</h2>
                </div>
                  </div>
...
<div class="page-inner"> 
	...
	<div class="row">
		<div class="col-sm-3">
		 <div class='form-group'>
                    <label for="customer">Return No</label>
		    <div class="required-field-block">
                    <input class="form-control" id="Return_no" name="Return_no" size="30" type="text" placeholder="Type and select Return No"/>
		 ...
		 <div class='col-sm-3'>    
                <div class='form-group' >
                    <label for="quotationdate">Return Date</label>
			...
			<div class="text">*</div>
             ...
             <div class="col-sm-3">
		 <div class='form-group'>
                    <label for="customer">Return From</label>
		    <div class="required-field-block">
                    <input class="form-control" id="return_from" name="return_from" size="30" type="text" placeholder="Type and select Return From"/>
		    <div class="required-icon">
			<div class="text">*</div>
		     </div>
		     </div>
	...
	<div class="row">
	 ...
	 <!--  <div class='col-sm-3'>
		 ...
		 <div class="col-sm-3">
		 <div class='form-group'>
                    <label for="customer">Display Requirement</label>
		    <div class="required-field-block">
                    <input class="form-control" id="Display_Requirement" name="Display_Requirement" size="30" type="text" placeholder="Type and select Display Requirement"/>
		    <div class="required-icon">
			<div class="text">*</div>
		     </div>
		     </div>
    ...
    <div class='pull-right centered save-view'>            
            ...
            <li><a href="#" >Save & New</a></li>
                  ...
                  <li><a  href="#">Save & Close</a></li>
                   ...
                   <button type="button" class="btn btn-primary"  onclick="showReturns()"><i class="glyphicon glyphicon-eye-open"></i><span>&nbsp;View</span></button>	

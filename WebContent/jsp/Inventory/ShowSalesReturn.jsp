...
<div id="page-inner">
         <div class="row">
                <div class="col-md-11 col-sm-12 col-xs-8">
                  <h2 class="page-header">Sales Return(SR)</h2>
                </div>	
         </div>
         <div class="row row-no-margin" > 
				...
				<label for="so_customer">SR No</label>
				<input type="text" class="form-control"  name="Sr_No" id="Sr_No" placeholder=" Sales Return No Search..." value="" onblur=""  onkeyup="" onkeypress=""/>
				</div>
            </div>
			...
			<a onclick="addSalesReturn()"  class="btn btn-success"  ><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;New Sales Return</a>
			</div>
			</div>	
			...
			<div class='col-sm-12'>    
				...
				<div class="input-group-btn pull-left">
                    <div class="btn-group">
						...
						<div class='col-sm-6 '>
						<label for="material" >Return Type</label>
						<div class="box-group ">
...
<div class="btn-group pull-right">
  ...
  <ul class="dropdown-menu">
    <li><a href="#">Print Returns</a></li>
    <li role="separator" class="divider"></li>
    <li><a href="#">Post Credit Note</a></li>
     <li><a href="#">Send Credit Note</a></li>
  </ul>
</div>
...
<th width="60">SR&nbsp;Date</th>
<th width="80">Customer</th>
<th width="85">Return&nbsp;Type</th>
<th width="70">Warehouse</th>
<th width="109">Buyer&nbsp;Order&nbsp;No</th>
<th width="80">Product</th>
<th width="54">Colour</th>
<th width="40">UOM</th>
<th width="53">Quanity</th>
<th width="45">Rate(USD)</th>
<th width="52">Amount(INR)</th>
...
<select class="form-control" id="unit">
			    ...
			    <option> Post Credit Note</option>  
	 			  </select></td>

...
<div class="row-no-margin row">
                <div class="col-md-11 col-sm-8 col-xs-12">
                    <h2 class="add-page-header" style="margin:18px 0 0px 20px;">Gate Entry (GE)</h2>
                </div>
                 </div>
...
<div class="page-inner"> 
    ...
    <div class='row 'style="margin-top:40px;">
                ...
                <button type="button" class="btn btn-primary"  onclick="showGateEntry()"><i class="glyphicon glyphicon-eye-open"></i><span>&nbsp;View</span></button>	
            	</div>
                </div>      
    </div> 

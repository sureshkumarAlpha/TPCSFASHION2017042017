 ...
 <jsp:param value="2" name="screen_type"/>
     ...
     <div class="row-no-margin row">
                <div class="col-md-11 col-sm-8 col-xs-12">
                    <h2 class="add-page-header" style="margin:18px 0 0px 20px;">Issues (ISS)</h2>
                </div>
                  </div>
	...
	<div class="row">
		<div class="col-sm-3">
		 <div class='form-group'>
                    <label for="customer">Issue No</label>
		    <div class="required-field-block">
                    <input class="form-control" id="Issue_no" name="Issue_no" size="30" type="text" placeholder="Type and select Issue No"/>
		 ...
		 <div class='col-sm-3'>    
                <div class='form-group' >
                    <label for="quotationdate">Issue Date</label>
			...
			<div class="text">*</div>
             ...
             <div class="col-sm-3">
		 <div class='form-group'>
                    <label for="customer">Issue To</label>
		    <div class="required-field-block">
                    <input class="form-control" id="Issue_to" name="Issue_to" size="30" type="text" placeholder="Type and select Issue To"/>
		    <div class="required-icon">
			<div class="text">*</div>
		     </div>
		     </div>
    ...
    <div class='pull-right centered save-view'>            
            ...
            <li><a href="#" >Save & New</a></li>
                  ...
                  <li><a  href="#">Save & Close</a></li>
                   ...
                   <button type="button" class="btn btn-primary"  onclick="showIssues()"><i class="glyphicon glyphicon-eye-open"></i><span>&nbsp;View</span></button>	

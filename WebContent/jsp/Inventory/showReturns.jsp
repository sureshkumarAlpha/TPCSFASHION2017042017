...
<div id="page-inner">
         <div class="row">
                <div class="col-md-11 col-sm-12 col-xs-8">
                  <h2 class="page-header">Returns (RET)</h2>
                </div>	
         </div>
         <div class="row row-no-margin" > 
				...
				<label for="so_customer">Return No</label>
				<input type="text" class="form-control"  name="Return_No" id="Return_No" placeholder=" Return No Search..." value="" onblur=""  onkeyup="" onkeypress=""/>
				</div>
            </div>
			...
			<a onclick="addReturns()"  class="btn btn-success"  ><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;New Returns</a>
			</div>
			</div>	
  ...
  <div class="row paginationstyle">		
			<div class='col-sm-12'>    
				...
				<ul class="pagination pull-left"  >
					...
					<li>
							<a href='javascript:showReturns();' data-toggle="tooltip" title="Refresh">
				...
				<div class='col-sm-6'>    
                <div class='form-group'>
					<label for="material">Return From</label> 
...
<th width="71">Return&nbsp;No</th>
<th width="86">Return&nbsp;Date</th>
<th width="85">Return&nbsp;Type</th>
<th width="109">Return&nbsp;From</th>
<th width="76">Warehouse</th>
<th width="60">IO&nbsp;NO</th>
<th width="98">Item</th>
<th width="72">Colour</th>
<th width="69">UOM</th>
<th width="87">Quantity</th>

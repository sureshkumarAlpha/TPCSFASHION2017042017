...
<div id="page-inner">
         <div class="row">
                <div class="col-md-11 col-sm-12 col-xs-8">
                    <h3 class="page-header">Goods Receipt (GR)</h3>
                </div>	
         ...
         <div class="row row-no-margin" > 
			...
			<a onclick="addGoodsReceipt()"  class="btn btn-success"  ><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;New Goods Receipt</a>
			</div>
			</div>	
		</div>														
		...
		<div class="row paginationstyle">
			<div class='col-sm-12'>
			  <ul class="pagination pull-left"  >
					...
					<li>
							<a href='javascript:showGoodsReceipt();' data-toggle="tooltip" title="Refresh">

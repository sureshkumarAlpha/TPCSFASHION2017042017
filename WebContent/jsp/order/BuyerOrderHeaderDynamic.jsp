<c:choose>
	<c:when test="${dynamicHeaderfield.fixed}">
		...
		<c:choose>
		<c:when test="${ControlName=='bo_no'}">		
			<div class='col-sm-12'>
				<div class='form-group'>
					<label for="bo_prefix">${dynamicHeaderfield.displayName}</label>
					<div class="form-group has-feedback">
						<select name="bo_prefix" id="bo_prefix" class="auto-prefix" <c:if test="${header_info.headerMode ne 'n' }">disabled="disabled" </c:if> <c:if test="${header_info.headerMode eq 'n'}">  autofocus </c:if> onchange="getAutoSlNo(this.value);" >
						...
						<input type="text" id="bo_no" name="bo_no" maxlength="7" placeholder="${dynamicHeaderfield.displayName}" class="auto-no" <c:if test="${header_info.headerMode ne 'n' or (header_info.checkAutoNoType eq 'common' or header_info.checkAutoNoType eq 'seperate')}"> readonly="readonly" </c:if>  /> 
						<span  <c:if test="${header_info.headerMode eq 'n'}"> data-toggle="modal" data-target="#autoNoModal" onclick="getAutoNoData();"  </c:if> > 
							<a href="#" data-toggle="tooltip" class="field-icon" title="Click here to enable or disable autogeneration of Order number">
		...
		<c:otherwise>
		<c:choose>
			<c:when test="${ControlName=='bo_date'}">
			<div class='col-sm-12'>
				<div class='form-group'>
				 ...
				 jQuery('#bo_date').datepicker({
						...
						changeDate: function(event) {
	             		...
	             		// Revalidate the date field
	             			 jQuery('#validate-form').bootstrapValidator('revalidateField', 'bo_date');
		        		},
			...
			<div class="col-sm-12">
				<div class='form-group'>
					...
					<div class="required-field-block">
						<input type="text" class="form-control" id="buyer_name" name="buyer_name" maxlength="${dynamicHeaderfield.length}" placeholder="Type & Select ${dynamicHeaderfield.displayName}" />
						<div class="required-icon">
							<div class="text">*</div>
						</div>
					</div>
			...
			<div class="col-sm-12">
				<div class='form-group'>
					...
					<div class="required-field-block">
						<input type="text" class="form-control" id="buyer_po_no" name="buyer_po_no" maxlength="${dynamicHeaderfield.length}" placeholder="Type & Select ${dynamicHeaderfield.displayName}" />
						<div class="required-icon">
							<div class="text">*</div>
						</div>
					</div>
			...
			<div class="col-sm-12">
				<div class='form-group'>
					...
					<div class="required-field-block">
						<input type="text" class="form-control" id="currency_name" name="currency_name" maxlength="${dynamicHeaderfield.length}" placeholder="Type & Select ${dynamicHeaderfield.displayName}" />
			...
			<div class="col-sm-12">
				<div class='form-group'>
					...
					<div class="required-field-block">
						<input type="text" class="form-control" id="ex_rate" name="ex_rate" maxlength="${dynamicHeaderfield.length}" placeholder="Enter ${dynamicHeaderfield.displayName}" />
						<div class="required-icon">
							<div class="text">*</div>
						</div>
					</div>
			...
			<div class="col-sm-12">
				<div class='form-group'>
					...
					<input type="text" class="form-control" id="mode_of_ship" name="mode_of_ship" maxlength="${dynamicHeaderfield.length}" placeholder="Enter ${dynamicHeaderfield.displayName}" />
				</div>
			</div>
			...
			<div class="col-sm-12">
				<div class='form-group'>
					...
					<input type="text" class="form-control" id="season_name" name="season_name" maxlength="${dynamicHeaderfield.length}" placeholder="Type & Select ${dynamicHeaderfield.displayName}" />
			...
			<div class="col-sm-12">
				<div class='form-group'>
					...
					<input type="text" class="form-control" id="pi_no" name="pi_no" maxlength="${dynamicHeaderfield.length}" placeholder="Enter ${dynamicHeaderfield.displayName}" />
				</div>
			</div>
			...
			<div class="col-sm-12">
				<div class='form-group'>
					...
					<input type="text" class="form-control" id="pi_date" name="pi_date" maxlength="${dynamicHeaderfield.length}" placeholder="Select ${dynamicHeaderfield.displayName}" />
				</div>
			</div>
			...
			<div class="col-sm-12">
				<div class='form-group'>
					...
					<input type="text" class="form-control" id="agent_name" name="agent_name" maxlength="${dynamicHeaderfield.length}" placeholder="Type & Select ${dynamicHeaderfield.displayName}" />
			...
			<div class="col-sm-12">
				<div class='form-group'>
					...
					<input type="text" class="form-control" id="customer_plan_no" name="customer_plan_no" maxlength="${dynamicHeaderfield.length}" placeholder="Enter ${dynamicHeaderfield.displayName}" />
				</div>
			</div>
						...
						<script type="text/javascript">
						      ...
						      jQuery('#${dynamicHeaderfield.pageFieldName}').datepicker({
									...
									changeDate: function(event) {
				             			...
				             			event.stopPropagation();
				             		// Revalidate the date field
				             			 jQuery('#validate-form').bootstrapValidator('revalidateField', '${dynamicHeaderfield.pageFieldName}');
					        		},
					        		changeMonth: function(event) {
				             			event.preventDefault();
				             			event.stopPropagation();

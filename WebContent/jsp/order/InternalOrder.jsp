...
<div id="page-inner">
         <div class="row">
                <div class="col-md-11 col-sm-12 col-xs-8">
                  <h2 class="page-header">Internal Order</h2>
                </div>	
         </div>
       ...
       <%--          <c:forEach items="${fixedfields}" var="objFixedfields" > --%>
			...
			<a onclick="addInternalOrder()"  class="btn btn-success"  ><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;New Internal Order</a>
			</div>
			</div>	
  ...
  <div class="row paginationstyle">		
			<div class='col-sm-12'>    
				...
				<ul class="pagination pull-left"  >
					...
					<li>
							<a href='javascript:showInternalOrder();' data-toggle="tooltip" title="Refresh">
...
<th width="80">Date</th>
<th width="87">Customer</th>
<th width="64">Buyer PO</th>
<th width="64">Unit</th>
<th width="65">Group</th>
<th width="85">Product</th>
<th width="64">Colour</th>
<th width="64">UOM</th>
<th width="73">Order.Qty.</th>
<th width="73">Rate (USD)</th>
<th width="64">Ship Mode</th>
<th width="137">Description</th>
<th width="77">Ship Date</th>
...
<td width="73">21</td>
<td width="64">SEA</td>
<td width="137">Tote Bag</td>
<td width="77">2-Jan-16</td>
<td></td>
...
<tr class="datarow">
  ...
  <td width="73">17</td>
  <td width="64">SEA</td>
  <td width="137">Woven    Belt</td>
  <td width="77">4-Jan-16</td>
  <td></td>
  <td><div class="checkbox">
...
<tr class="datarow">
  ...
  <td width="68">26-Nov-15</td>
  <td width="87">CustomerB</td>
  <td width="64">B657854</td>
  <td width="64">UNIT    A</td>
  <td width="65">Wallet</td>
  ...
  <td width="73">15</td>
  <td width="64">SEA</td>
  <td width="137">Passcase</td>
  <td width="77">5-Jan-16</td>
  <td></td>
  <td><div class="checkbox">
...
<tr class="datarow">
  ...
  <td width="73">24</td>
  <td width="64">SEA</td>
  <td width="137">Mocassin</td>
  <td width="77">6-Jan-16</td>
  <td></td>
  <td><div class="checkbox">
...
<tr class="datarow">
  ...
  <td width="73">23</td>
  <td width="64">SEA</td>
  <td width="137">Woven    bag</td>
  <td width="77">7-Jan-16</td>
  <td></td>
  <td><div class="checkbox">
...
<tr class="datarow">
  ...
  <td width="73">22</td>
  <td width="64">SEA</td>
  <td width="137">Cemented</td>
  <td width="77">8-Jan-16</td>
  <td></td>
  <td><div class="checkbox">
...
<tr class="datarow">
  ...
  <td width="68">30-Nov-15</td>
  <td width="87">CustomerC</td>
  <td width="64">C7578485</td>
  <td width="64">UNIT    A</td>
  <td width="65">Shoe    Upper</td>
...
<tr class="datarow">
  ...
  <td width="73">20</td>
  <td width="64">SEA</td>
  <td width="137">Swing    Bag</td>
  <td width="77">10-Jan-16</td>
  <td></td>
  <td><div class="checkbox">
...
<tr class="datarow">
  ...
  <td width="73">17</td>
  <td width="64">SEA</td>
  <td width="137">Clutch</td>
  <td width="77">11-Jan-16</td>
  <td></td>
  <td><div class="checkbox">

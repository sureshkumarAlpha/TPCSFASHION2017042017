...
<div id="page-inner">
         <div class="row">
                <div class="col-md-11 col-sm-12 col-xs-8">
                  <h2 class="page-header">Production Start</h2>
                </div>	
         </div>
         <div class="row row-no-margin" > 
			...
			<a onclick="addProductionStart()"  class="btn btn-success"  ><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;New Production Start</a>
			</div>
			</div>	
  ...
  <div class="row row-no-margin paginationstyle">		
			<div class='col-sm-12'>    
				...
				<ul class="pagination pull-left"  >
					<li>
							<a href='javascript:addProductionStart();' data-toggle="tooltip" title="Refresh">
...
<th width="60">Production Start Date</th>
...
<select class="form-control" id="unit">
			    ...
			    <option>Cancel</option>
				 <option>Print</option>
			    <option>Post Production End</option>  

...
<div id="page-inner">
         <div class="row">
                <div class="col-md-11 col-sm-12 col-xs-8">
                  <h2 class="page-header">Jobcard</h2>
                </div>	
         </div>
         <div class="row row-no-margin" > 
			...
			<a onclick="addJobcard()"  class="btn btn-success"  ><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;New Jobcard</a>
			</div>
			</div>	
  ...
  <div class="row row-no-margin paginationstyle">		
			<div class='col-sm-12'>    
				...
				<ul class="pagination pull-left"  >
					<li>
							<a href='javascript:showJobcard();' data-toggle="tooltip" title="Refresh">
                        ...
                        <div class="dropdown dropdown-lg">
                            ...
                            <div id="filter-dropdown" class="dropdown-menu dropdown-menu-left"  >
                                <div class="row">
										...
										<div class='col-sm-6'>    
                <div class='form-group'>
					<label  for="group">Color</label> 
					<input type="text" class="form-control" name="group" id="group" value="${group}" onkeyup="clearId(event,'group','group_id')" placeholder="Select Color"/>
...
<th width="101">Order Qty </th>
<th width="69">Jobcard Qty </th>
...
<select class="form-control" id="unit">
			    ...
			    <option>Cancel</option>
				 <option>Print Jobcard</option>
			    <option>Print Cutting Slip</option>  

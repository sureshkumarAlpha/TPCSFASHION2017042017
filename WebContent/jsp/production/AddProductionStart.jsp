 ...
 <jsp:param value="2" name="screen_type"/>
     ...
     <div class="row-no-margin row">
                <div class="col-md-11 col-sm-8 col-xs-12">
                    <h2 class="add-page-header" style="margin:18px 0 0px 20px;">Production Start</h2>
                </div>
                  </div>
...
<div class="page-inner"> 
	...
	<div class="row">
		...
		<div class='col-sm-3'>    
                <div class='form-group' >
                    <label for="quotationdate">Production Start Date</label>
	...
	<div class="row">
		...
		<div class='col-sm-3'>    
                <div class='form-group' >
                    <label for="quotationdate">Production Start Time</label>
    ...
    <div class='pull-right centered save-view'>            
            ...
            <li><a href="#" >Save & New</a></li>
                  ...
                  <li><a  href="#">Save & Close</a></li>
                   ...
                   <button type="button" class="btn btn-primary"  onclick="showProductionStart()"><i class="glyphicon glyphicon-eye-open"></i><span>&nbsp;View</span></button>	
